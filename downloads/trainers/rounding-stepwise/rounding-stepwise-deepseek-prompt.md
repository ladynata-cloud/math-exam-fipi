...
Создай интерактивный HTML-тренажёр по теме: **округление натуральных и десятичных чисел**.

Ориентир: «Округление чисел» на сайте mathexam.space.
...
Пошаговый тренажёр по округлению чисел.
