...
Создай интерактивный HTML-тренажёр по теме: **разряды и десятичные дроби**.

Ориентир: «Касса разрядов: десятичные дроби» на сайте mathexam.space.
...
Отработка разрядов и десятичных дробей.
