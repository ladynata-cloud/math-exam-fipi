...
Создай интерактивный HTML-тренажёр по теме: **отрицательные числа и числовая прямая**.

Ориентир: «Отрицательные числа: числовая прямая» на сайте mathexam.space.
...
Тренировка понимания отрицательных чисел на прямой.
