...
Создай интерактивный HTML-тренажёр по теме: **арифметическая и геометрическая прогрессии**.

Ориентир: «ОГЭ: прогрессии» на сайте mathexam.space.
...
Тренажёр по прогрессиям с группами задач и загрузкой банка данных.
