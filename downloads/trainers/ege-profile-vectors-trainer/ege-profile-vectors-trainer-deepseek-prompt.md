...
Создай интерактивный HTML-тренажёр по теме: **векторы**.

Ориентир: «ЕГЭ профиль: векторы» на сайте mathexam.space.
...
Генератор задач по векторам с пошаговым режимом, прогрессом и отправкой отчёта учителю.
