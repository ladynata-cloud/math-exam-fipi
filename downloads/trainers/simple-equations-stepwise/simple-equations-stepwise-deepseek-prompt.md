...
Создай интерактивный HTML-тренажёр по теме: **простые уравнения**.

Ориентир: «Простые уравнения пошагово» на сайте mathexam.space.
...
Пошаговая отработка решения простых уравнений.
