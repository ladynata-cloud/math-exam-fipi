...
Создай интерактивный HTML-тренажёр по теме: **планиметрия, задание 1**.

Ориентир: «ЕГЭ профиль: задание 1, планиметрия» на сайте mathexam.space.

## Аудитория

- Предмет: геометрия
- Уровень: 10–11 класс, ЕГЭ профиль
...
Генератор случайных задач по планиметрии с марафоном и сохранением прогресса.
