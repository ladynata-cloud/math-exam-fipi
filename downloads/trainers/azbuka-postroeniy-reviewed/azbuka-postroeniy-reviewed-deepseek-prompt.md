...
Создай интерактивный HTML-тренажёр по теме: **построения циркулем и линейкой**.

Ориентир: «Азбука построений» на сайте mathexam.space.
...
Линейка тренажёров по базовым геометрическим построениям.
