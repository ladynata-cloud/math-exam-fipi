...
Создай интерактивный HTML-тренажёр по теме: **построение биссектрисы угла**.

Ориентир: «Биссектриса угла» на сайте mathexam.space.
...
Экспериментальный тренажёр на построение биссектрисы.
