...
Создай интерактивный HTML-тренажёр по теме: **практические задачи 1–5**.

Ориентир: «ОГЭ: задания 1–5» на сайте mathexam.space.
...
Комплект практических задач ОГЭ первой части: шины, печи, квартиры, тарифы и другие сюжеты.
