...
Создай интерактивный HTML-тренажёр по теме: **формулы сокращённого умножения**.

Ориентир: «Формулы сокращённого умножения — линейка» на сайте mathexam.space.
...
Линейка отработки квадратов суммы и разности, разности квадратов и смешанных случаев.
