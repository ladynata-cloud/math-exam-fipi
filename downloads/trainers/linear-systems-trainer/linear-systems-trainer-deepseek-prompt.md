...
Создай интерактивный HTML-тренажёр по теме: **системы линейных уравнений**.

Ориентир: «Системы линейных уравнений» на сайте mathexam.space.
...
Тренажёр для отработки систем линейных уравнений.
