...
Создай интерактивный HTML-тренажёр по теме: **утверждения и логика задачи 19**.

Ориентир: «ОГЭ: задача 19» на сайте mathexam.space.
...
Карточки для отработки задачи 19 ОГЭ с проверкой и пояснениями.
