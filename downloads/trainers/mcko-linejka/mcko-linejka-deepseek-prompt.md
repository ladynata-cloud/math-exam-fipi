...
Создай интерактивный HTML-тренажёр по теме: **задания линейки МЦКО, ежедневная отработка и отчёт учителю**.

Ориентир: «Линейка тренажёров МЦКО» на сайте mathexam.space.
...
Тренажёр с дневной целью, прогрессом ученика и отправкой отчёта учителю.
